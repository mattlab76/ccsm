...
@test "search: kein Treffer zeigt Meldung" {
    create_test_sessions
    run search_sessions "gibtsnicht"
...
@test "search: Trefferzähler ist korrekt" {
    ...
    run search_sessions "#infra"
    assert_success
    assert_output --partial "2 Treffer"
}
